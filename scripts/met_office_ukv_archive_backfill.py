...
def main():
    ...
    ap.add_argument("--cycles", default="3,15",
                    help="Comma-separated cycle hours. UKV runs hourly but only the 03Z and 15Z cycles "
                         "extend to 120h leads; other cycles cap at ~24-48h. Empirically verified 2026-04-28.")
    ap.add_argument("--leads", default="24,48,72,120",
                    help="Comma-separated lead hours. UKV's long-range cycles publish exactly to 120h.")
