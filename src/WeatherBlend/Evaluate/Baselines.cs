...
#pragma warning restore CS0618
    ...
    // -----------------------------------------------------------------------
    // Vector-row API (BlenderSpec + RegressionTrainingRow). New canonical
    // path used by Phase 1+ blenders.
    // -----------------------------------------------------------------------

    /// <summary>
    /// Persistence baseline against a vector-row dataset. Truth lookup is
    /// at <c>row.ValidTimeUtc - lagHours</c>; ERA5(T) used as the truth at T.
    /// </summary>
    public static double[] Persistence(
    ...
    /// <summary>Climatology baseline against vector-row datasets.</summary>
    public static double[] Climatology(
